...
이 글은 [[recyclerview-series|RecyclerView 시리즈]]의 첫 번째 글이다. 여기서는 가로/세로 혼합 예제 전체를 따라가고, `RecycledViewPool` 자체는 [[recyclerview-recycledviewpool-deep-dive|RecycledViewPool 내부 흐름 깊게 보기]]에서 더 자세히 정리한다.
